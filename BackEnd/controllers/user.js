...
export const updateProfile=async (req,res)=>{
       try{
        ...
        //  console.log(file)
          ...
          let skillsArray;
        if(skills){
             skillsArray=skills.split(",");  //skills string format m comma separates change kr diya array m
          ...
          //update data  we can use findbyidandupdate() as well
